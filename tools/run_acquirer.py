...
class ImageAcquirer:
    ...
    def capture_part(self, part_num, folder_name):
        ...
        num_angles = 8
        steps_per_angle = 512 // num_angles # 4096 steps per rev / 8 = 512 approx (28BYJ-48 is 4096 steps/rev half-step)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--set", type=str, default="45345-1", help="Set Number to process (default: Spike Essential 45345-1)")
