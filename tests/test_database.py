...
class TestDatabaseManager(unittest.TestCase):
    ...
    def _populate_dummy_data(self):
        ...
        # Insert a Set
        cursor.execute(
            "INSERT INTO sets (set_num, name, year, theme_id, num_parts) VALUES ('1234-1', 'Test Set', 2023, 1, 10)"
        )

        # Insert Parts
        cursor.execute(
            "INSERT INTO parts (part_num, name, img_url, image_folder_name) VALUES ('3001', 'Brick 2x4', 'http://img', NULL)"
        )
        cursor.execute(
            "INSERT INTO parts (part_num, name, img_url, image_folder_name) VALUES ('3002', 'Brick 2x3', 'http://img', 'photos/3002')"
        )
        ...
        cursor.execute(
            "INSERT INTO inventory_parts (inventory_id, part_num, color_id, quantity, is_spare, img_url) VALUES (100, '3001', 15, 5, 0, 'http://img')"
        )
        # Part 3002 in Tan (qty 2)
        cursor.execute(
            "INSERT INTO inventory_parts (inventory_id, part_num, color_id, quantity, is_spare, img_url) VALUES (100, '3002', 19, 2, 0, 'http://img')"
        )
